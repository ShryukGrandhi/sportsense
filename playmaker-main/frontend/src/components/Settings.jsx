              ...
              <div className="space-y-8">
                ...
                <div className="bg-[#111111] border border-white p-12">
                  ...
                  <div className="text-center">
                    <button className="bg-white text-[#0a0a0a] px-12 py-4 text-sm font-medium uppercase tracking-wider transition-all hover:bg-gray-100">
                      Upgrade to Pro
                    </button>
                    <p className="text-xs text-gray-600 mt-4 uppercase tracking-wider">Coming Soon</p>
                  </div>
                </div>
              </div>
            )}
