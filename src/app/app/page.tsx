...
import '@/playmaker/App.css';
import { AuthProvider, useAuth } from '@/playmaker/context/AuthContext';
import TopBar from '@/playmaker/components/TopBar';

// Lazy load heavy components for better initial load time
const PerplexityChatInterface = lazy(() => import('@/playmaker/components/PerplexityChatInterface'));
const AuthModal = lazy(() => import('@/playmaker/components/AuthModal'));
const PlayerComparison = lazy(() => import('@/playmaker/components/PlayerComparison'));
const Settings = lazy(() => import('@/playmaker/components/Settings'));
const PulseAI = lazy(() => import('@/playmaker/components/PulseAI'));
